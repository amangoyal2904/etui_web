                  ...
                  <div className={styles.signMenu}>
                    ...
                    <p className={styles.userName}>{`Hi ${userInfo?.firstName}`}</p>
                      ...
                      <div className={styles.bgWhite}>
                        ...
                        <a href={`${APIS_CONFIG.DOMAIN[window.APP_ENV]}referrals`} rel="nofollow noreferrer" target="_blank" className={`${styles.menulist} ${styles.refer} ${styles.cSprite_b}`}>Refer & Earn <img src="https://img.etimg.com/photo/107514300.cms" width="36" height="17" className={styles.new_badge} alt="New Feature" loading="lazy" ></img></a>
