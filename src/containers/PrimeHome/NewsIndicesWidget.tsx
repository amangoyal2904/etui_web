                    ...
                    <div className="data_table">
                        {indicesObj.secName === 'Indices' ? (
                            ...
                            compData?.map(comp => {
                                return (
                                    <p className="comp_data" key={comp.indexId}>
                                        <a target="_blank" rel="noopener noreferrer" href={`https://${isDev ? 'etdev8243' : 'economictimes'}.indiatimes.com/${comp.seoName}/stocks/companyid-${comp.companyId}.cms`} className="comp_name">
                                            {comp.companyName}
                                        </a>
