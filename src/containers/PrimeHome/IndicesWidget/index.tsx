  ...
  return (
    <div>
      ...
      <div className={styles.chartContainer}>
        <iframe className={styles.chart} src={`https://${true ? 'etdev8243' : 'economictimes'}.indiatimes.com/renderchart.cms?type=index&symbol=NSE Index&exchange=NSE&period=1d&height=220&transparentBg=1`} />
