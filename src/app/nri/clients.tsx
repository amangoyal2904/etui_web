...
const NRIClientPage = ({addata, dynamicFooterData, menuData, versionControl, response, pageSeo, isDev, ssoid, isprimeuser, APP_ENV, pageData}:any)=>{
    ...
    //console.log("NRIClientPage-------------------------", adData);
    return (              
            <section>
                <NriList {...response} objVc={versionControl} isprimeuser={isprimeuser} isDev={isDev} ssoid={ssoid} addata={addata}/>
